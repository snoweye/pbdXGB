...
// MPI may not support C++ anymore
#ifdef PBDR_SKIP_MPICXX
#include "./internal/rabit-inl_mpicc.h"  // MPI C library is sufficient
#else
#include "./internal/rabit-inl.h"  // implementation of template functions
#endif
