...
inline void Reducer(const void *src_, void *dst_, int len, const MPI_Datatype &dtype) {
...
inline void ReducerSafe_(const void *src_, void *dst_, int len_, const MPI_Datatype &dtype) {
...
inline void ReducerAlign_(const void *src_, void *dst_,
                          int len_, const MPI_Datatype &dtype) {
